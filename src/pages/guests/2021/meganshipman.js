...
export const name = "Megan Shipman"
const MeganShipmanPage = () => {
    ...
    return (
        <Layout>
            ...
            <PageContent>
                <Guest personName={name} guestTitle="Voice Actor and ADR Director for anime, video games, and more" guestSocials={guestSocials}>
                    ...
                    <br /><br />As an ADR Director, Megan has directed shows like “Love Live! Nijigasaki High School Idol Club”, “Show by Rock!! Mashumairesh!!”, “Scarlet Nexus”, “No Guns Life”, and much more!
                </Guest>
            </PageContent>
        </Layout>
    )
