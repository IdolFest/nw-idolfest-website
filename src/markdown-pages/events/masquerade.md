...
4. All cosplay policies must be followed by all contestants. 
   ...
   2. Examples of blackface/yellowface include darkening the skin to appear as a different human race.  
   3. Examples of Asian-fishing include changing the eye shape to look more narrow/elongated and taping eyelids.
   4. Unnatural colors like blue, purple, etc are appropriate.
...
1. Audio must be submitted as an mp3 file to the Lead of Cosplay Events before October 8th, 2023. Details on how to submit audio will be provided to contestants after their application is accepted.
...
7. References of the character are required for judging. References can be physically printed or digital (shown on a phone or tablet screen), however physical references are prefered.
   ...
   2. Build books or work in progress photos are highly encouraged but not required. Build books or other physically printed material must be picked up by contestants after the Masquerade.
8. Costumes that have previously won awards in competition will be permitted, as long as there has been at least 30% improvement to the costume since it won the award.  
   ...
   2. Costumes that have won a Best in Category award must be entered at a higher level. (Ex: a Best in Novice costume with at least 30% improvement could be entered as a Journeyman costume.)  
